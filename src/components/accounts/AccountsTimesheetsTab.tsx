...
import AccountsTimesheetEditModal from "@/components/accounts/AccountsTimesheetEditModal";
...
export default function AccountsTimesheetsTab({
  ...
  const handleTimesheetSaved = (updated: AccountsTimesheetRow) => {
    setRows((current) =>
